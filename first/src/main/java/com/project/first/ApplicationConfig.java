...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.project.first.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "twitch-project-instance.clm5clecngbv.us-east-2.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "feather617";
