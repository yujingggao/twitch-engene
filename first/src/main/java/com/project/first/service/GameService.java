...
import com.project.first.entity.db.Item;
import com.project.first.entity.db.ItemType;
import com.project.first.entity.response.Game;
...
public class GameService {
    private static final String TOKEN = "Bearer 0zw4fu3sh8xxsuhxt9d0yo4wf6nncy";
    private static final String CLIENT_ID = "xhph3js8aje0gfy0hb19t6l3i3yl8x";
